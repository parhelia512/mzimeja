...
AppId={{2FCD745D-F3C2-4115-B537-D6AE6E066B83}
AppName=MZ-IME日本語入力 64-bit
AppVerName=MZ-IME日本語入力 (64-bitデバッグ版) 0.9.9.3
AppPublisher=片山博文MZ
...
DefaultDirName={pf64}\mzimeja
DefaultGroupName=MZ-IME日本語入力 (64-bitデバッグ版)
OutputDir=.
OutputBaseFilename=mzimeja64-0.9.9.3d-setup
Compression=lzma
